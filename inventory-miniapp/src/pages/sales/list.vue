...
const statusOptions = [{ v: null, l: '全部状态' }, { v: 0, l: '草稿' }, { v: 4, l: '待审批' }, { v: 1, l: '已出库' }, { v: 2, l: '已取消' }]
...
async function fetchPendingCount() {
  try {
    const res = await request.get('/sales-order/page', { params: { page: 1, size: 1, status: 4 } })
...
function handleReset() {
  ...
  startDate.value = ''; endDate.value = ''; whCascade.value = []; fetchList()
}
